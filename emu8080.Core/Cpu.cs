...
namespace emu8080.Core
{
    public class Cpu
    {
        ...
        static void SetupOpcodes()
        {
            ...
            _ops.Add(0x91, Ops.SUB_C);
            _ops.Add(0x92, Ops.SUB_D);
            _ops.Add(0x93, Ops.SUB_E);
            _ops.Add(0x94, Ops.SUB_H);
            _ops.Add(0x95, Ops.SUB_L);
            _ops.Add(0x96, Ops.SUB_M);
            _ops.Add(0x97, Ops.SUB_A);
            _ops.Add(0x98, Ops.SBB_B);
